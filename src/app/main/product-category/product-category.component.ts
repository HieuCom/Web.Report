...
export class ProductCategoryComponent implements OnInit {
  ...
  //Load data
  public search() {
    this._dataService.get('/productCategory/getall?filter=' + this.filter)
  ...
  public getListForDropdown() {
    this._dataService.get('/productCategory/getallhierachy')
      .subscribe((response: any[]) => {
        //console.log(response);
        this._productCategories = response;
      }, error => this._dataService.handleError(error));
  ...
  public showEdit(id: string) {
    this._dataService.get('/productCategory/detail/' + id).subscribe((response: any) => {
  ...
  public deleteConfirm(id: string): void {
    // this._dataService.delete('/productCategory/delete', 'id', id).subscribe((response: any) => {
  ...
  public saveChanges(valid: boolean) {
    if (valid) {
      if (this.entity.ID == undefined) {
        this._dataService.post('/productCategory/add', JSON.stringify(this.entity)).subscribe((response: any) => {
          this.search();
        ...
        this._dataService.put('/productCategory/update', JSON.stringify(this.entity)).subscribe((response: any) => {
          this.search();
          this.addEditModal.hide();
