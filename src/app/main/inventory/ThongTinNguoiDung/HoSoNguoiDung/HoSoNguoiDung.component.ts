...
// @Component({
//   selector: "app-HoSoNguoiDung",
//   templateUrl: "./HoSoNguoiDung.component.html",
//   styleUrls: ["./HoSoNguoiDung.component.css"],
// })
// export class HoSoNguoiDungComponent implements OnInit {
